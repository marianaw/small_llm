"""
Copied from nanoGPT:
    https://github.com/karpathy/nanoGPT/blob/eba36e84649f3c6d840a93092cb779a260544d08/data/openwebtext/prepare.py

Saves the openwebtext dataset to a binary file for training. following was helpful:
    https://github.com/HazyResearch/flash-attention/blob/main/training/src/datamodules/language_modeling_hf.py

After running `prepare.py` we get:
    -train_??.tfrecord are ~17GB, val_??.tfrecord ~8.5MB
    -train has ~9B tokens (9,035,582,198)
    -val_??.tfrecord has ~4M tokens (4,434,897)
"""
